...
async function loadCategoriesForNav() {
    ...
    try {
        ...
        categoryDropdown.innerHTML = response.data.map(category => 
            `<li><a class="dropdown-item" href="pages/products.html?category=${category}">${category}</a></li>`
        ).join('');
    } catch (error) {
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="pages/product-details.html?id=${product.id}" class="btn btn-primary">View</a>
                    </div>
                </div>
            </div>
        `).join('');
            ...
            <div class="col-md-3">
                <div class="card border-success">
                    ...
                    <div class="card-body">
                        ...
                        <a href="pages/product-details.html?id=${product.id}" class="btn btn-success">Buy Now</a>
                    </div>
                </div>
            </div>
        `).join('');
...
function handleSearch() {
    ...
    if (searchInput.trim()) {
        window.location.href = `pages/products.html?search=${searchInput}`;
    }
}
